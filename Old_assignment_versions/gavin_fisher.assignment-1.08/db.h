...
extern std::list<pokemon_t> pokemons;
extern std::list<moves_t> moves;
extern std::list<pokemon_moves_t> pokemon_moves;
extern std::list<pokemon_species_t> pokemon_species;
extern std::list<experience_t> experience;
extern std::list<type_names_t> type_names;
extern std::list<pokemon_stats_t> pokemon_stats;
extern std::list<stats_t> stats;
extern std::list<pokemon_types_t> pokemon_types;
